...
const AllUsers = () => {
    ...
    const [createUserAdmin, setCreateUserAdmin] = useState<boolean | undefined>()
        ...
        <div className="div-all-users">
            ...
            <article style={{ display: mainHide ? "none" : "block" }}>
                ...
                <div className="register" id="register" style={{ display: hide ? "block" : "none" }}>
                    <Register key={editedUser?.id} onTogle={toggleHide} user={editedUser} admin={admin} owner={owner} createUserAdmin={createUserAdmin} onRegister={handleUserSubmit} />
                </div >
            </article>
            ...
            <main className="main" style={{ display: mainHide ? "block" : "none" }}>
                <AppBar id="appBar" sx={{ margin: '0px', backgroundColor: 'rgb(196 196 217)', justifyContent: 'space-evenly' }}>
                    <Toolbar sx={{ justifyContent: 'space-evenly' }}>
                        ...
                        {admin ? <Button onClick={createUser} sx={{ ':hover': { backgroundColor: "rgb(234 233 233)", color: 'rgb(4 4 4)' }, backgroundColor: "rgb(4 4 4)", color: 'rgb(234 233 233)', }}>Create new USER</Button> : ''}
